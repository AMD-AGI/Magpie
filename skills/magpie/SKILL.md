...
- Consult the repository's [compatibility matrix](../../docs/reference/compatibility-matrix.md), [analyze/compare guide](../../docs/how-to/analyze-compare.md), [benchmark guide](../../docs/how-to/benchmarking/benchmark.md), [profiling and TraceLens guide](../../docs/how-to/benchmarking/profiling-options.md), and [kernel source finder guide](../../docs/how-to/kernel-source-finder.md) when the task depends on those details.
