...
```bash
pip install "magpie-eval @ git+https://github.com/AMD-AGI/Magpie.git@0.3.0"
```
...
```bash
pip install "magpie-eval[all] @ git+https://github.com/AMD-AGI/Magpie.git@0.3.0"
```
...
- **IntelliKit integrations** (human-readable AMD profiling metrics, AMD
  ...
  ```bash
  pip install "magpie-eval[intellikit] @ git+https://github.com/AMD-AGI/Magpie.git@0.3.0"
  ```
