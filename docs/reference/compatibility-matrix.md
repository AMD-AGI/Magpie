...
- IntelliKit integrations are optional (pinned commit `3f45cd314d455b652a1246678511b40547fe521e`). Install with `.[intellikit]` or individual extras. Some components require ROCm/HIP build tools.
